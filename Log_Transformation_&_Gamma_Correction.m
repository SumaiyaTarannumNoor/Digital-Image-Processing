...
for i = 1:r
    ...
    for j = 1:c
        ...
        if imgray(i, j) >= r_min && imgray(i, j) <= r_max
            ...
            sliced_img(i, j) = output_value;  % Set pixel to specified output value
...
imshow(imgray);  % Show original grayscale image
...
imshow(sliced_img);  % Show intensity-sliced image
